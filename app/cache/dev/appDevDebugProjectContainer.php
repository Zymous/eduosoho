...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'edusoho', 'user' => 'root', 'password' => 'abby0329', 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Topxia\\Service\\Common\\Connection'), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7beaeeb8ed6b87a64bf8a3cfaf23eb89a54b9fda276d02a9ee41943df9f6e71c');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'slcx9foex8g4kc8koko080coc00c8oo');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $w = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'slcx9foex8g4kc8koko080coc00c8oo', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    {
        $this->services['session.handler.pdo.connection'] = $instance = new \PDO('mysql:host=localhost;port=3306;dbname=edusoho', 'root', 'abby0329');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Topxia\Service\Common\RedisFactory A Topxia\Service\Common\RedisFactory instance.
     */
    protected function getSession_Handler_Redis_FactoryService()
    {
        return $this->services['session.handler.redis.factory'] = call_user_func(array('Topxia\\Service\\Common\\RedisFactory', 'instance'), $this);
    }
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), '6.15.4', '%s?%s'), array());
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('slcx9foex8g4kc8koko080coc00c8oo');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'abby0329',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'zh_CN',
            'secret' => 'slcx9foex8g4kc8koko080coc00c8oo',
            'user_partner' => 'none',
            ...
            'kernel.secret' => 'slcx9foex8g4kc8koko080coc00c8oo',
            ...
            'twig.options' => array(
                ...
                'paths' => array(
                    'D:\\WAMP\\WWW\\edusoho\\app/../web/customize' => 'customize',
                    'D:\\WAMP\\WWW\\edusoho\\app/../src/Topxia/WebBundle/Resources/views' => 'topxiaweb',
                    'D:\\WAMP\\WWW\\edusoho\\app/../web/themes' => 'theme',
                    'D:\\WAMP\\WWW\\edusoho\\app/../' => 'root',
                ),
