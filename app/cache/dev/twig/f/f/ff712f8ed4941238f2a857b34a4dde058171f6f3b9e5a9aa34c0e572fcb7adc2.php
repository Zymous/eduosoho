...
class __TwigTemplate_ff712f8ed4941238f2a857b34a4dde058171f6f3b9e5a9aa34c0e572fcb7adc2 extends Twig_Template
{
  ...
  ";
        ...
        <td>
          ...
          下一版本: ";
                // line 12
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["mainAppUpgrade"]) ? $context["mainAppUpgrade"] : $this->getContext($context, "mainAppUpgrade")), "package", array()), "toVersion", array()), "html", null, true);
                echo "&nbsp;
          最新版本: ";
                // line 13
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["mainAppUpgrade"]) ? $context["mainAppUpgrade"] : $this->getContext($context, "mainAppUpgrade")), "latestVersion", array()), "html", null, true);
                echo "
        </td>
      </tr>
    ";
  ...
  ";
      ...
      ";
            ...
            if ((isset($context["app_count"]) ? $context["app_count"] : $this->getContext($context, "app_count"))) {
                // line 38
                echo "          ";
                if (((((array_key_exists("status", $context)) ? (_twig_default_filter((isset($context["status"]) ? $context["status"] : $this->getContext($context, "status")), 0)) : (0)) == 1) && ((isset($context["app_count"]) ? $context["app_count"] : $this->getContext($context, "app_count")) == 1))) {
                    // line 39
          ...
          ";
                    // line 41
                    if ((((array_key_exists("status", $context)) ? (_twig_default_filter((isset($context["status"]) ? $context["status"] : $this->getContext($context, "status")), 0)) : (0)) == 1)) {
                        echo twig_escape_filter($this->env, ((isset($context["app_count"]) ? $context["app_count"] : $this->getContext($context, "app_count")) - 1), "html", null, true);
                    } else {
                        // line 42
                        echo "          ";
                        echo twig_escape_filter($this->env, (isset($context["app_count"]) ? $context["app_count"] : $this->getContext($context, "app_count")), "html", null, true);
                        echo "
          ";
                    }
                    // line 43
      ...
      ";
        ...
        <tr><td>新应用</td><td>";
            // line 48
            if (((isset($context["unInstallAppCount"]) ? $context["unInstallAppCount"] : $this->getContext($context, "unInstallAppCount")) > 0)) {
                echo "<span class=\"glyphicon glyphicon-info-sign text-info\"></span> 还有 <span class=\"badge\">";
                echo twig_escape_filter($this->env, (isset($context["unInstallAppCount"]) ? $context["unInstallAppCount"] : $this->getContext($context, "unInstallAppCount")), "html", null, true);
        ...
        if (($this->env->getExtension('topxia_web_twig')->getSetting("course.live_student_capacity", 0) > 0)) {
            ...
            if (($this->env->getExtension('topxia_web_twig')->getSetting("course.live_course_enabled") == 0)) {
              ...
              ";
                ...
                // line 64
                echo "                ";
                if ((twig_length_filter($this->env, (isset($context["liveCourseStatus"]) ? $context["liveCourseStatus"] : $this->getContext($context, "liveCourseStatus"))) > 0)) {
                    // line 65
                    echo "                  ";
