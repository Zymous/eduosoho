...
class __TwigTemplate_9fb0a1347987c9417a9abaad96c7361c0bfff9e8bd11865e6701d7c873b53aa1 extends Twig_Template
{
  ...
  <form id=\"login-record-search-form\" class=\"form-inline\" action=\"\" method=\"get\" novalidate> 
    ...
    <div class=\"form-group\">
      <select id=\"keywordType\" name=\"keywordType\" class=\"form-control\">
        ";
        // line 14
        echo $this->env->getExtension('topxia_html_twig')->selectOptions($this->env->getExtension('topxia_web_twig')->getDict("userKeyWordTypes"), $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "keywordType"), "method"));
        echo "
      </select>
    </div>
...
<table id=\"teacher-table\" class=\"table table-striped table-hover\" data-search-form=\"#user-search-form\">
  ...
  <tbody>
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["logRecords"]) ? $context["logRecords"] : $this->getContext($context, "logRecords")));
        $context['loop'] = array(
