  ...
  ";
    ...
    \t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["favoriteQuestion"]) {
                // line 11
                echo "    \t\t\t";
                $context["paper"] = $this->getAttribute((isset($context["testpapers"]) ? $context["testpapers"] : $this->getContext($context, "testpapers")), $this->getAttribute($this->getAttribute((isset($context["targets"]) ? $context["targets"] : $this->getContext($context, "targets")), $this->getAttribute($context["favoriteQuestion"], "target", array()), array(), "array"), "id", array()), array(), "array");
                // line 12
                echo "    \t\t\t";
                $context["question"] = $this->getAttribute((isset($context["questions"]) ? $context["questions"] : $this->getContext($context, "questions")), $this->getAttribute($context["favoriteQuestion"], "questionId", array()), array(), "array");
                // line 13
                echo "    \t\t\t
    \t\t\t\t";
                // line 14
