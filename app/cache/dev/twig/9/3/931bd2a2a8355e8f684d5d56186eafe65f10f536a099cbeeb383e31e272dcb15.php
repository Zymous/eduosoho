...
class __TwigTemplate_931bd2a2a8355e8f684d5d56186eafe65f10f536a099cbeeb383e31e272dcb15 extends Twig_Template
{
    ...
    {
        // line 1
        $context["favorites"] = ((array_key_exists("favorites", $context)) ? (_twig_default_filter((isset($context["favorites"]) ? $context["favorites"] : $this->getContext($context, "favorites")), array())) : (array()));
        // line 2
        echo "
";
        // line 3
...
";
        // line 8
        if ((twig_in_filter("favorite", (isset($context["flags"]) ? $context["flags"] : $this->getContext($context, "flags"))) && ((array_key_exists("id", $context)) ? (_twig_default_filter((isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")), null)) : (null)))) {
            // line 9
            echo "  <button data-url=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("my_favorite_question", array("id" => $this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "id", array()), "targetType" => "testpaper", "targetId" => $this->getAttribute((isset($context["paper"]) ? $context["paper"] : $this->getContext($context, "paper")), "id", array()))), "html", null, true);
            echo "\" class=\"btn btn-sm btn-default favorite-btn\" ";
            if (twig_in_filter($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "id", array()), (isset($context["favorites"]) ? $context["favorites"] : $this->getContext($context, "favorites")))) {
...
";
        // line 13
        if ((twig_in_filter("analysis", (isset($context["flags"]) ? $context["flags"] : $this->getContext($context, "flags"))) && ((array_key_exists("id", $context)) ? (_twig_default_filter((isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")), null)) : (null)))) {
            // line 14
            echo "  ";
            if (( !$this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "analysis", array()) == "")) {
                // line 15
