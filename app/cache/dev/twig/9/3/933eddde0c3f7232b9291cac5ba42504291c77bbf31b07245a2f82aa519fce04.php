...
class __TwigTemplate_933eddde0c3f7232b9291cac5ba42504291c77bbf31b07245a2f82aa519fce04 extends Twig_Template
{
...
(isset($context["paperResult"]) ? $context["paperResult"] : $this->getContext($context, "paperResult")), "status", array()) == "reviewing")) {
            // line 7
  ...
  ";
        // line 15
        if (($this->getAttribute((isset($context["paperResult"]) ? $context["paperResult"] : $this->getContext($context, "paperResult")), "status", array()) == "reviewing")) {
            // line 16
            echo "    <div class=\"alert alert-warning\">老师正在批阅试卷，批阅完成后会以站内私信通知您批阅结果，请稍等。</div>
  ";
        } elseif (($this->getAttribute(        // line 17
(isset($context["paperResult"]) ? $context["paperResult"] : $this->getContext($context, "paperResult")), "status", array()) == "finished")) {
            // line 18
            echo "    ";
            if ($this->getAttribute((isset($context["paperResult"]) ? $context["paperResult"] : $this->getContext($context, "paperResult")), "teacherSay", array())) {
                // line 19
                echo "      <div class=\"alert alert-success\">
        <div class=\"\"><strong>评语：</strong></div>
        <div class=\"mtm\">";
                // line 21
                echo $this->env->getExtension('topxia_web_twig')->bbCode2HtmlFilter($this->getAttribute((isset($context["paperResult"]) ? $context["paperResult"] : $this->getContext($context, "paperResult")), "teacherSay", array()));
                echo "</div>
      </div>
    ";
            }
            // line 24
            echo "    ";
            if ((($this->getAttribute((isset($context["paperResult"]) ? $context["paperResult"] : $this->getContext($context, "paperResult")), "passedStatus", array()) == "unpassed") && ((array_key_exists("target", $context)) ? (_twig_default_filter((isset($context["target"]) ? $context["target"] : $this->getContext($context, "target")), null)) : (null)))) {
                // line 25
                echo "      <div class=\"alert alert-danger\">
        您未通过考试，请<a href=\"";
                // line 26
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("course_lesson_redo_test", array("lessonId" => $this->getAttribute((isset($context["target"]) ? $context["target"] : $this->getContext($context, "target")), "id", array()), "testId" => $this->getAttribute((isset($context["paperResult"]) ? $context["paperResult"] : $this->getContext($context, "paperResult")), "testId", array()))), "html", null, true);
                echo "\">重新参加考试</a>，或者重新学习课程。
      </div>
    ";
            } elseif (($this->getAttribute(            // line 28
(isset($context["paperResult"]) ? $context["paperResult"] : $this->getContext($context, "paperResult")), "passedStatus", array()) == "passed")) {
                // line 29
          ...
          ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    if (($this->getAttribute($context["item"], "questionType", array()) != "material")) {
                        ...
                        if ((($this->getAttribute((isset($context["paperResult"]) ? $context["paperResult"] : $this->getContext($context, "paperResult")), "status", array()) == "reviewing") && ($this->getAttribute($context["item"], "questionType", array()) == "essay"))) {
                            echo "checking";
