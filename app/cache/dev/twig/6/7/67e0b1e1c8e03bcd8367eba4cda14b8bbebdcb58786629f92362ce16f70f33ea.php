...
class __TwigTemplate_67e0b1e1c8e03bcd8367eba4cda14b8bbebdcb58786629f92362ce16f70f33ea extends Twig_Template
{
...
\t\t      ";
                ...
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "answer", array()));
...
\t\t\t    \t  ";
                    // line 16
                    if (((isset($context["userAnswer"]) ? $context["userAnswer"] : $this->getContext($context, "userAnswer")) == "")) {
                        // line 17
                        echo "\t\t\t    \t  。你未回答
\t\t\t    \t  ";
                    } elseif (($this->getAttribute($this->getAttribute($this->getAttribute(                    // line 18
(isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "testResult", array()), "status", array()) == "right")) {
                        // line 19
                        echo "\t\t\t    \t  ，你的答案　<strong class=\"text-success\">";
                        echo twig_escape_filter($this->env, (isset($context["userAnswer"]) ? $context["userAnswer"] : $this->getContext($context, "userAnswer")), "html", null, true);
                        echo "</strong>。 
\t\t\t    \t  ";
                    } elseif (($this->getAttribute($this->getAttribute($this->getAttribute(                    // line 20
(isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "testResult", array()), "status", array()) == "partRight")) {
                        // line 21
...
\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["answer"]) {
                    ...
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "id", array()), "html", null, true);
                    echo "\" placeholder=\"填空(";
                    echo twig_escape_filter($this->env, (isset($context["input_index"]) ? $context["input_index"] : $this->getContext($context, "input_index")), "html", null, true);
                    echo ")答案，请填在这里\" ";
                    if ((($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "question", array(), "any", false, true), "testResult", array(), "any", false, true), "answer", array(), "any", false, true), ((isset($context["input_index"]) ? $context["input_index"] : $this->getContext($context, "input_index")) - 1), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "question", array(), "any", false, true), "testResult", array(), "any", false, true), "answer", array(), "any", false, true), ((isset($context["input_index"]) ? $context["input_index"] : $this->getContext($context, "input_index")) - 1), array(), "array"), null)) : (null))) {
                        echo "value=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "testResult", array()), "answer", array()), ((isset($context["input_index"]) ? $context["input_index"] : $this->getContext($context, "input_index")) - 1), array(), "array"), "html", null, true);
                        echo "\"";
                    }
                    echo " />
\t\t\t\t\t";
                    // line 50
                    $context["input_index"] = ((isset($context["input_index"]) ? $context["input_index"] : $this->getContext($context, "input_index")) + 1);
                    // line 51
                    echo "\t\t\t\t";
                }
                $_parent = $context['_parent'];
