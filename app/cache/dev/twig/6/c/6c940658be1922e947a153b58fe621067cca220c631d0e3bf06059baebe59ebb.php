...
class __TwigTemplate_6c940658be1922e947a153b58fe621067cca220c631d0e3bf06059baebe59ebb extends Twig_Template
{
...
\t\t  ";
        // line 23
        echo $this->env->getExtension('topxia_html_twig')->selectOptions($this->env->getExtension('topxia_web_twig')->getDict("articleProperty"), $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "property"), "method"), "--属性--");
        echo "
\t\t</select>
\t</div>
\t<div class=\"form-group\">
...
\t\t  ";
        // line 28
        echo $this->env->getExtension('topxia_html_twig')->selectOptions($this->env->getExtension('topxia_web_twig')->getDict("articleStatus"), $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "status"), "method"), "--发布状态--");
        echo "
\t\t</select>
\t</div>
