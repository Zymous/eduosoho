...
<div class=\"topic-list\">
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["thread"]) {
            // line 5
            echo "    ";
            $context["author"] = $this->getAttribute((isset($context["users"]) ? $context["users"] : $this->getContext($context, "users")), $this->getAttribute($context["thread"], "userId", array()), array(), "array");
            // line 6
            echo "    ";
