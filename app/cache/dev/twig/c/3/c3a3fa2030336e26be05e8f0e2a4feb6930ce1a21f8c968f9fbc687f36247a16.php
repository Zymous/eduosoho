...
class __TwigTemplate_c3a3fa2030336e26be05e8f0e2a4feb6930ce1a21f8c968f9fbc687f36247a16 extends Twig_Template
{
...
<form class=\"well well-sm form-inline\">
  ...
  <div class=\"form-group\">
    <select class=\"form-control\" name=\"cycle\">
        ";
        // line 28
        echo $this->env->getExtension('topxia_html_twig')->selectOptions($this->env->getExtension('topxia_web_twig')->getDict("jobCycle"), $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "cycle"), "method"), "--执行周期--");
        echo "
    </select>
  </div>
...
$context["job"], "targetType", array()) == "lesson")) {
                ...
                // line 62
                echo "            ";
                $context["course"] = $this->env->getExtension('topxia_data_twig')->getData("Course", array("courseId" => $this->getAttribute((isset($context["lesson"]) ? $context["lesson"] : $this->getContext($context, "lesson")), "courseId", array())));
                // line 63
                echo "            课程：《<a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("course_show", array("id" => $this->getAttribute((isset($context["course"]) ? $context["course"] : $this->getContext($context, "course")), "id", array()))), "html", null, true);
                echo "\" target='_blank'>";
