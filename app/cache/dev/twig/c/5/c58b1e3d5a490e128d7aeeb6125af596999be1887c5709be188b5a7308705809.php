...
class __TwigTemplate_c58b1e3d5a490e128d7aeeb6125af596999be1887c5709be188b5a7308705809 extends Twig_Template
{
    ...
    <div class=\"form-group\">
      ...
      <div class=\"controls col-md-8 col-md-offset-3\" id=\"show-list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["sort"]) {
            ...
            // line 52
            echo "            ";
            if ((isset($context["userCustomField"]) ? $context["userCustomField"] : $this->getContext($context, "userCustomField"))) {
                // line 53
                echo "              <button type=\"button\" class=\"btn btn-default btn-xs\">
                ";
                // line 54
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["userCustomField"]) ? $context["userCustomField"] : $this->getContext($context, "userCustomField")), "title", array()), "html", null, true);
                echo "
              </button>
            ";
            } elseif (            // line 56
(isset($context["userInfoFieldsDict"]) ? $context["userInfoFieldsDict"] : $this->getContext($context, "userInfoFieldsDict"))) {
                // line 57
                echo "              <button type=\"button\" class=\"btn btn-default btn-xs\">
                ";
                // line 58
                echo twig_escape_filter($this->env, (isset($context["userInfoFieldsDict"]) ? $context["userInfoFieldsDict"] : $this->getContext($context, "userInfoFieldsDict")), "html", null, true);
                echo "
              </button>
            ";
            }
      ...
      <div class=\"controls col-md-8 col-md-offset-2\" id=\"show-register-list\" style=\"display:none\">
        ...
        echo "            ";
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["commonFields"]) ? $context["commonFields"] : $this->getContext($context, "commonFields")));
        foreach ($context['_seq'] as $context["key"] => $context["field"]) {
            if ((isset($context["commonFields"]) ? $context["commonFields"] : $this->getContext($context, "commonFields"))) {
                // line 76
                ...
                echo "\" ";
                if (twig_in_filter($context["key"], (isset($context["checkedFieldsKeys"]) ? $context["checkedFieldsKeys"] : $this->getContext($context, "checkedFieldsKeys")))) {
                    echo "checked=true";
                }
                echo " />
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            if (((array_key_exists("userFields", $context)) ? (_twig_default_filter((isset($context["userFields"]) ? $context["userFields"] : $this->getContext($context, "userFields")), null)) : (null))) {
                // line 86
                echo "              <li class=\"list-group-item clearfix\" data-role=\"item\" >
                <span class=\"glyphicon glyphicon-resize-vertical sort-handle\"></span>&nbsp;
                <input type=\"checkbox\" name=\"userinfoFields[]\" value=\"";
                ...
                echo "\" ";
                if (twig_in_filter($this->getAttribute($context["field"], "fieldName", array()), (isset($context["checkedFieldsKeys"]) ? $context["checkedFieldsKeys"] : $this->getContext($context, "checkedFieldsKeys")))) {
                    echo "checked=true";
                }
                echo " />
                <input type=\"hidden\"  name=\"userinfoFieldNameArray[]\" value=\"";
      ...
      <div class=\"controls col-md-8 col-md-offset-2\" id=\"show-fields-list\" style=\"display:none\">
        ...
        foreach ($context['_seq'] as $context["key"] => $context["field"]) {
            if ((isset($context["commonFields"]) ? $context["commonFields"] : $this->getContext($context, "commonFields"))) {
                ...
                echo twig_escape_filter($this->env, $context["key"], "html", null, true);
                echo "\" ";
                if (twig_in_filter($context["key"], (isset($context["checkedUserFieldsKeys"]) ? $context["checkedUserFieldsKeys"] : $this->getContext($context, "checkedUserFieldsKeys")))) {
                    echo "checked=true";
                }
                echo " />
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            if (((array_key_exists("userFields", $context)) ? (_twig_default_filter((isset($context["userFields"]) ? $context["userFields"] : $this->getContext($context, "userFields")), null)) : (null))) {
                ...
                echo twig_escape_filter($this->env, $this->getAttribute($context["field"], "fieldName", array()), "html", null, true);
                echo "\" ";
                if (twig_in_filter($this->getAttribute($context["field"], "fieldName", array()), (isset($context["checkedUserFieldsKeys"]) ? $context["checkedUserFieldsKeys"] : $this->getContext($context, "checkedUserFieldsKeys")))) {
                    echo "checked=true";
                }
                echo " />
                <input type=\"hidden\"  name=\"registerFieldNameArray[]\" value=\"";
