...
class __TwigTemplate_53fc15f44027a3be539234fab41fba90cc72dbdffcfdf2672ff4a54e1cf02d49 extends Twig_Template
{
...
";
        // line 3
        if (($this->getAttribute((isset($context["lesson"]) ? $context["lesson"] : $this->getContext($context, "lesson")), "type", array()) != "live")) {
            // line 4
            echo "<h5>课时简介</h5>
<div class=\"lesson-about\">
\t";
            // line 6
            if ($this->getAttribute((isset($context["lesson"]) ? $context["lesson"] : $this->getContext($context, "lesson")), "summary", array())) {
                // line 7
                echo "    ";
                echo nl2br($this->env->getExtension('topxia_web_twig')->spaceToNbsp($this->getAttribute((isset($context["lesson"]) ? $context["lesson"] : $this->getContext($context, "lesson")), "summary", array())));
                echo "
\t";
            } else {
                // line 9
...
";
        // line 14
        if (((twig_in_filter($this->getAttribute((isset($context["lesson"]) ? $context["lesson"] : $this->getContext($context, "lesson")), "type", array()), array(0 => "video", 1 => "audio")) && $this->env->getExtension('topxia_web_twig')->getSetting("course.student_download_media")) && (isset($context["file"]) ? $context["file"] : $this->getContext($context, "file")))) {
            // line 15
            echo "<h5>课时音视频文件下载</h5>
<div class=\"lesson-about\">
  <a href=\"";
            // line 17
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("course_lesson_media_download", array("courseId" => $this->getAttribute((isset($context["lesson"]) ? $context["lesson"] : $this->getContext($context, "lesson")), "courseId", array()), "lessonId" => $this->getAttribute((isset($context["lesson"]) ? $context["lesson"] : $this->getContext($context, "lesson")), "id", array()))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('topxia_web_twig')->fileSizeFilter($this->getAttribute((isset($context["file"]) ? $context["file"] : $this->getContext($context, "file")), "size", array())), "html", null, true);
            echo " (点击下载)</a>
</div>
";
        }
