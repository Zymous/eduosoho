...
class __TwigTemplate_5eeaf4e045490942ab451f6877e9fedad5ed45040092166605c66e6a35d8adc3 extends Twig_Template
{
...
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["paperResult"]) {
                // line 7
                echo "\t\t\t";
                $context["testpaper"] = $this->getAttribute((isset($context["testpapers"]) ? $context["testpapers"] : $this->getContext($context, "testpapers")), $this->getAttribute($context["paperResult"], "testId", array()), array(), "array");
                // line 8
                echo "\t\t\t";
                $context["student"] = $this->getAttribute((isset($context["users"]) ? $context["users"] : $this->getContext($context, "users")), $this->getAttribute($context["paperResult"], "userId", array()), array(), "array");
                // line 9
                echo "\t\t\t";
                if (((array_key_exists("courses", $context)) ? (_twig_default_filter((isset($context["courses"]) ? $context["courses"] : $this->getContext($context, "courses")), null)) : (null))) {
                    // line 10
                    echo "\t\t\t\t";
                    $context["course"] = $this->getAttribute((isset($context["courses"]) ? $context["courses"] : $this->getContext($context, "courses")), $this->env->getExtension('topxia_web_twig')->getCourseidFilter($this->getAttribute((isset($context["testpaper"]) ? $context["testpaper"] : $this->getContext($context, "testpaper")), "target", array())), array(), "array");
                    // line 11
                    echo "\t\t\t";
                }
                // line 12
