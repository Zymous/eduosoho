...
class __TwigTemplate_52dff3f551d3af1db1e387dedb9fc5728e8e7ebabca5cd3fab78579467acfc2c extends Twig_Template
{
  ...
  <div class=\"panel-body\">
    <form id=\"course-base-form\" class=\"form-horizontal\" method=\"post\">
      ...
      <div class=\"form-group dynamic-collection\" id=\"course-goals-form-group\">
        ...
        // line 34
        echo twig_jsonencode_filter($this->getAttribute((isset($context["course"]) ? $context["course"] : $this->getContext($context, "course")), "goals", array()));
        echo "</script>
      ...
      <div class=\"form-group\" id=\"course-audiences-form-group\">
        ...
        <div class=\"col-md-8 controls\">
          ...
          <script type=\"text/plain\" data-role=\"model\">";
        // line 61
        echo twig_jsonencode_filter($this->getAttribute((isset($context["course"]) ? $context["course"] : $this->getContext($context, "course")), "audiences", array()));
        echo "</script>
          <script type=\"text/x-handlebars-template\" data-role=\"item-template\">
            ";
        // line 70
