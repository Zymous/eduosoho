...
class __TwigTemplate_35fc3d3ef20af3588c673d2bb3e521e41253d1a5304752ca97b272ba45ece762 extends Twig_Template
{
  ...
  <form class=\"form-inline\">
    ...
    <div class=\"form-group\">
      <select class=\"form-control\" name=\"keywordType\">
        ";
        // line 14
        echo $this->env->getExtension('topxia_html_twig')->selectOptions(array("content" => "内容", "courseId" => "课程编号", "courseTitle" => "课程名"), $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "get", array(0 => "keywordType"), "method"));
        echo "
      </select>
    </div>
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["note"]) {
          ...
          <td>
            ";
            // line 70
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["admin_macro"]) ? $context["admin_macro"] : $this->getContext($context, "admin_macro")), "user_link", array(0 => $this->getAttribute((isset($context["users"]) ? $context["users"] : $this->getContext($context, "users")), $this->getAttribute($context["note"], "userId", array()), array(), "array")), "method"), "html", null, true);
            echo "
            <br>
