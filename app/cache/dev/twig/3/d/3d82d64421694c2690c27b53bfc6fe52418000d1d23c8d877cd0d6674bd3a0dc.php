...
class __TwigTemplate_3d82d64421694c2690c27b53bfc6fe52418000d1d23c8d877cd0d6674bd3a0dc extends Twig_Template
{
  ...
  ";
      ...
      <div class=\"media-body pts\">
        ...
        <div class=\"metas\">
          ";
            // line 31
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["web_macro"]) ? $context["web_macro"] : $this->getContext($context, "web_macro")), "user_avatar", array(0 => (isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), 1 => "userImg", 2 => "avatar-xxs"), "method"), "html", null, true);
            echo "
          ";
            // line 32
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["web_macro"]) ? $context["web_macro"] : $this->getContext($context, "web_macro")), "user_link", array(0 => (isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), 1 => "pls"), "method"), "html", null, true);
            echo "发起了问题
          ...
          ";
            ...
            最后回复 ";
                // line 41
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["web_macro"]) ? $context["web_macro"] : $this->getContext($context, "web_macro")), "user_link", array(0 => $this->getAttribute((isset($context["lastPostMembers"]) ? $context["lastPostMembers"] : $this->getContext($context, "lastPostMembers")), $this->getAttribute($context["thread"], "lastPostMemberId", array()), array(), "array"), 1 => "link-muted"), "method"), "html", null, true);
                echo "
            <span class=\"divider\">•</span> 
            ";
                // line 43
