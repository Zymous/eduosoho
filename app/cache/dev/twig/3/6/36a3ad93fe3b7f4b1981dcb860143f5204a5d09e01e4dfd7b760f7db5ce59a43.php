...
class __TwigTemplate_36a3ad93fe3b7f4b1981dcb860143f5204a5d09e01e4dfd7b760f7db5ce59a43 extends Twig_Template
{
...
\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "metas", array()), "choices", array()));
...
\t\t\t\t";
                // line 18
                if (twig_in_filter($context["key"], $this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "answer", array()))) {
                    // line 19
                    echo "\t\t\t\t\t";
...
(isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "question", array()), "testResult", array()), "status", array()) == "partRight")) {
                    ...
                    echo twig_escape_filter($this->env, twig_join_filter((isset($context["keys_answer"]) ? $context["keys_answer"] : $this->getContext($context, "keys_answer")), ","), "html", null, true);
...
\t\t\t\t\t<label class=\"";
                    // line 54
                    if (($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "questionType", array()) == "single_choice")) {
                        echo "radio";
                    } else {
                        echo "checkbox";
                    }
                    echo "-inline ";
                    if (twig_in_filter((isset($context["choiceIndex"]) ? $context["choiceIndex"] : $this->getContext($context, "choiceIndex")), (isset($context["keys_answer"]) ? $context["keys_answer"] : $this->getContext($context, "keys_answer")))) {
                        echo "active";
                    }
                    echo "\">
\t\t\t\t\t\t<input type=\"";
