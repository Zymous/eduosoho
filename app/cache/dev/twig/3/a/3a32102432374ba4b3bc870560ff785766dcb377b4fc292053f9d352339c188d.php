...
class __TwigTemplate_3a32102432374ba4b3bc870560ff785766dcb377b4fc292053f9d352339c188d extends Twig_Template
{
    ...
    {
        // line 2
        $context["esBarMenu"] = (isset($context["status"]) ? $context["status"] : $this->getContext($context, "status"));
        // line 1
...
<ul class=\"list-unstyled\">
  ";
        // line 10
        if ((isset($context["testPaperResults"]) ? $context["testPaperResults"] : $this->getContext($context, "testPaperResults"))) {
            // line 11
            echo "    ";
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["testPaperResults"]) ? $context["testPaperResults"] : $this->getContext($context, "testPaperResults")));
            $context['loop'] = array(
    ...
    ";
            ...
            // line 16
            echo "    ";
            if (((isset($context["testCount"]) ? $context["testCount"] : $this->getContext($context, "testCount")) >= 10)) {
                // line 17
...
";
        // line 34
        if ((isset($context["homeworkResults"]) ? $context["homeworkResults"] : $this->getContext($context, "homeworkResults"))) {
            // line 35
            echo "  ";
            ...
            echo "  ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["homeworkResults"]) ? $context["homeworkResults"] : $this->getContext($context, "homeworkResults")));
            $context['loop'] = array(
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["homeworkResult"]) {
                ...
                // line 38
                echo "    ";
                $context["lesson"] = $this->getAttribute((isset($context["lessons"]) ? $context["lessons"] : $this->getContext($context, "lessons")), $this->getAttribute($context["homeworkResult"], "lessonId", array()), array(), "array");
                // line 39
                echo "    ";
                $context["course"] = $this->getAttribute((isset($context["courses"]) ? $context["courses"] : $this->getContext($context, "courses")), $this->getAttribute($context["homeworkResult"], "courseId", array()), array(), "array");
                // line 40
                echo "    ";
                $context["lessonUrl"] = (($this->env->getExtension('routing')->getPath("course_learn", array("id" => $this->getAttribute((isset($context["course"]) ? $context["course"] : $this->getContext($context, "course")), "id", array()))) . "#lesson/") . $this->getAttribute((isset($context["lesson"]) ? $context["lesson"] : $this->getContext($context, "lesson")), "id", array()));
                // line 41
                echo "    <li><i class=\"es-icon es-icon-chevronright\"></i><a target=\"_blank\" class=\"link-light\" href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("course_homework_result", array("courseId" => $this->getAttribute((isset($context["course"]) ? $context["course"] : $this->getContext($context, "course")), "id", array()), "homeworkId" => $this->getAttribute($context["homeworkResult"], "homeworkId", array()), "resultId" => $this->getAttribute($context["homeworkResult"], "id", array()), "userId" => $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "id", array()))), "html", null, true);
                echo "\">《";
  ...
  ";
            ...
            // line 43
            echo "  ";
            if (((isset($context["homeworkCount"]) ? $context["homeworkCount"] : $this->getContext($context, "homeworkCount")) >= 10)) {
                // line 44
                echo "    <li class=\"text-center\">
      <a class=\"link-light\" href=\"";
                // line 45
