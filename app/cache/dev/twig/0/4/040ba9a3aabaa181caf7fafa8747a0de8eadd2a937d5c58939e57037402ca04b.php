...
class __TwigTemplate_040ba9a3aabaa181caf7fafa8747a0de8eadd2a937d5c58939e57037402ca04b extends Twig_Template
{
    ...
    <div class=\"tab-content\">
      <div class=\"tab-pane\" id=\"file-chooser-upload-pane\">
        ...
        echo "\"
              data-params-url=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("uploadfile_params", array("targetType" => (isset($context["targetType"]) ? $context["targetType"] : $this->getContext($context, "targetType")), "targetId" => (isset($context["targetId"]) ? $context["targetId"] : $this->getContext($context, "targetId")), "storage" => $this->getAttribute((isset($context["storageSetting"]) ? $context["storageSetting"] : $this->getContext($context, "storageSetting")), "upload_mode", array()))), "html", null, true);
        echo "\"
              ";
        // line 29
        ...
        // line 32
        echo "              ";
        if (((array_key_exists("uploadSettings", $context)) ? (_twig_default_filter((isset($context["uploadSettings"]) ? $context["uploadSettings"] : $this->getContext($context, "uploadSettings")), null)) : (null))) {
            // line 33
            echo "                data-upload-settings=\"";
            echo twig_escape_filter($this->env, twig_jsonencode_filter((isset($context["uploadSettings"]) ? $context["uploadSettings"] : $this->getContext($context, "uploadSettings"))), "html", null, true);
            echo "\"
              ";
        }
        // line 35
      ...
      <div class=\"tab-pane\" id=\"file-chooser-course-pane\">
          <div id=\"file-browser\" data-role=\"course-file-browser\"
            data-url=\"";
        // line 69
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("uploadfile_browsers", array("targetType" => (isset($context["targetType"]) ? $context["targetType"] : $this->getContext($context, "targetType")), "targetId" => (isset($context["targetId"]) ? $context["targetId"] : $this->getContext($context, "targetId")))), "html", null, true);
        echo "\" 
            data-empty=\"暂无文件，请先上传。\">
          </div>
      </div>
