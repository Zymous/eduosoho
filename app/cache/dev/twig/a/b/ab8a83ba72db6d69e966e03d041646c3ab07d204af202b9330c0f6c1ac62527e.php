...
class __TwigTemplate_ab8a83ba72db6d69e966e03d041646c3ab07d204af202b9330c0f6c1ac62527e extends Twig_Template
{
  ...
  <td>
    <div class=\"btn-group\">
      ...
      <ul class=\"dropdown-menu\">
        ...
        <li><a href=\"#modal\" data-toggle=\"modal\" data-url=\"";
            // line 87
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_user_change_password", array("userId" => $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "id", array()))), "html", null, true);
            echo "\">修改密码</a></li>
        ...
        // line 91
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_user_send_passwordreset_email", array("id" => $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "id", array()))), "html", null, true);
        echo "\">发送密码重置邮件</a></li>
