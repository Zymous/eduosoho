...
class __TwigTemplate_2f5adefaba5d0f2724865e8b7e3c3f24b87968c92a2d817d72a9ff98aa2d27a5 extends Twig_Template
{
    ...
    \t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["myTestpaperResult"]) {
                ...
                if ((isset($context["myTestpaper"]) ? $context["myTestpaper"] : $this->getContext($context, "myTestpaper"))) {
                    // line 13
                    echo "    \t\t\t\t";
                    $context["course"] = $this->getAttribute((isset($context["courses"]) ? $context["courses"] : $this->getContext($context, "courses")), $this->env->getExtension('topxia_web_twig')->getCourseidFilter($this->getAttribute((isset($context["myTestpaper"]) ? $context["myTestpaper"] : $this->getContext($context, "myTestpaper")), "target", array())), array(), "array");
                    // line 14
                    echo "    \t\t\t";
                }
                // line 15
