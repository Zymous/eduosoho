...
class __TwigTemplate_7bd5885f7d73a118c55ede6c9632e7a9e18694697c873a283d084102d3f40081 extends Twig_Template
{
  ...
  <td>
    <span class=\"text-sm\">";
        // line 15
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["logRecord"]) ? $context["logRecord"] : $this->getContext($context, "logRecord")), "createdTime", array()), "Y-n-d H:i:s"), "html", null, true);
        echo "</span>
    <br>
    <a class=\"text-muted text-sm\" href=\"http://www.baidu.com/s?wd=";
        // line 17
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["logRecord"]) ? $context["logRecord"] : $this->getContext($context, "logRecord")), "ip", array()), "html", null, true);
        echo "\" target=\"_blank\">";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["logRecord"]) ? $context["logRecord"] : $this->getContext($context, "logRecord")), "ip", array()), "html", null, true);
        echo "</a>
  </td>
  <td>
    ";
        // line 20
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["logRecord"]) ? $context["logRecord"] : $this->getContext($context, "logRecord")), "location", array()), "html", null, true);
        echo "
  </td>
  <td>
    <a href=\"#modal\" data-toggle=\"modal\" data-url=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_login_record_details", array("id" => $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "id", array()))), "html", null, true);
