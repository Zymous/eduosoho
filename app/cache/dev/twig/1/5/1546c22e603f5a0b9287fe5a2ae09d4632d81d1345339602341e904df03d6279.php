...
class __TwigTemplate_1546c22e603f5a0b9287fe5a2ae09d4632d81d1345339602341e904df03d6279 extends Twig_Template
{
        ...
        <span style=\"color:#fed032;\"> 
          ";
            ...
            if ($this->getAttribute((isset($context["trialTime"]) ? $context["trialTime"] : null), "endTime", array(), "any", true, true)) {
                // line 13
                echo "            ";
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["trialTime"]) ? $context["trialTime"] : $this->getContext($context, "trialTime")), "endTime", array()), "Y年m月d日"), "html", null, true);
                echo " 
          ";
            } else {
                // line 14
