    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/my')) {
            ...
            if (0 === strpos($pathinfo, '/my/wrong')) {
                ...
                // my_wrongstatistics
                if ($pathinfo === '/my/wrongstatics') {
                    return array (  '_controller' => 'Topxia\\WebBundle\\Controller\\WrongcollectionController::staticAction',  '_route' => 'my_wrongstatistics',);
                }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/setting')) {
                ...
                // admin_setting_wrong_collection
                if ($pathinfo === '/admin/setting/wrong-collection') {
                    return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\CourseSettingController::wrongCollectionAction',  '_route' => 'admin_setting_wrong_collection',);
                }
